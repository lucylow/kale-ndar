...
export const BettingModal: React.FC<BettingModalProps> = ({ 
  ...
  const { isConnected } = useRealtimeUpdates({ marketId: market.id });
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-blue-700 font-medium">
                    {transactionStatus === 'pending' && 'Bet transaction pending...'}
                    {transactionStatus === 'confirmed' && 'Bet transaction confirmed!'}
                  </span>
                </div>
                <Button
                  variant="outline"
